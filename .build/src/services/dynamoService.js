...
var DynamoService = /** @class */ (function () {
    function DynamoService() {
    }
    DynamoService.createItem = function (item) {
    ...
    DynamoService.getItem = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            var dynamo, params, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        dynamo = new aws_sdk_1.DynamoDB.DocumentClient();
